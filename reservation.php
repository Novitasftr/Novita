                    ...
                    <div class="roberto-contact-form">
                        <form action="action-reservation.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                                    <input type="text" name="alamat" class="form-control mb-30" placeholder="Alamat Anda">
                                </div>
                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                                    <input type="text" name="hp" class="form-control mb-30" placeholder="Nomor Handphone Anda">
                                </div>
                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                                    <select name="kamar" id="kamar" class="form-control mb-30">
                                    <?php 
                                        if(isset($_GET['id'])){
                                            $id = $_GET['id'];
                                        }
                                        include 'config.php';
                                        $get = mysqli_query($koneksi,"SELECT * FROM tb_kamar");
                                        while($row = mysqli_fetch_array($get)){
                                    ?>
                                        <option value="<?= $row['id_kamar'] ?>"><?= $row['nama_kamar'] ?> - Rp. <?= number_format($row['harga_kamar']) ?> / Malam</option>
                                    <?php
                                        }
                                    ?>
                                    </select>
                                ...
                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                                    <select name="jml_kamar" id="jml_kamar" class="form-control mb-30">
                                        <option value="#">JUMLAH KAMAR</option>
                                        <?php 
                                            for($i=1; $i<=100; $i++){
                                                echo "<option value='".$i."'>".$i." Kamar</option>";
                                            }
                                        ?>
                                    </select>
                                </div>
                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                                    <select name="jml_dewasa" id="jml_dewasa" class="form-control mb-30">
                                        <option value="#">TAMU DEWASA</option>
                                        <?php 
                                            for($i=1; $i<=100; $i++){
                                ...
                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                                    <select name="jml_anak" id="jml_anak" class="form-control mb-30">
                                        <option value="#">TAMU ANAK ANAK</option>
                                        <?php 
                                            for($i=1; $i<=100; $i++){
                                                echo "<option value='".$i."'>".$i." Orang</option>";
                                            }
                                ...
                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                                    <input type="text" name="check_in" onfocus="(this.type='date')" class="form-control mb-30" placeholder="Check-in">
                                </div>
                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                                    <input type="text" name="check_out" class="form-control mb-30" onfocus="(this.type='date')" placeholder="Check-out">
                                </div>
                                <div class="col-12 text-center wow fadeInUp" data-wow-delay="100ms">
                                    <button type="submit" class="btn roberto-btn mt-15">Pesan Kamar</button>
                                </div>
                            </div>
                        </form>
                    </div>
