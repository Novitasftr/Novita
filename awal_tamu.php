...
<link href="assets/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="assets/css/headersw.css" rel="stylesheet">
  </head>
  <body>
 ...
 <div class="container py-4">
    ...
    <div class="p-5 mb-4 bg-light rounded-3">
      <div class="container-fluid py-5">
        <h1 class="display-5 fw-bold">PERMATA HOTEL BANDUNG</h1>
        <p class="col-md-8 fs-4">Permata Hotel Bandung, nyaman, asri, dijamin harga murah dengan kualitas bintang 5</p>
