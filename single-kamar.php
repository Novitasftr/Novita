...
<head>
    ...
    <!-- Title -->
    <title>PERMATA HOTEL BANDUNG &amp;</title>
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="top-header-content">
                            <a href="#"><i class="icon_phone"></i> <span>(+62) 8886364557</span></a>
    ...
    <?php 
        include 'config.php';
        $id = $_GET['id'];
        $get = mysqli_query($koneksi,"SELECT * FROM tb_kamar where id_kamar ='$id'");
        while($data = mysqli_fetch_array($get)){
    ?>
    <!-- Breadcrumb Area Start -->
    <div class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url(img/new-img/suite.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        <h2 class="room-title"><?= $data['nama_kamar'] ?></h2>
                        <h2 class="room-price">Rp <?= number_format($data['harga_kamar']) ?> <span>/ Per malam</span></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="single-room-details-area mb-50">
                        ...
                        <a href="reservation.php?id=<?= $data['id_kamar'] ?>" class="btn roberto-btn mb-50">Pesan sekarang</a>
                    ...
                    <div class="room-service mb-50">
                        ...
                        <ul>
                            <li><img src="img/core-img/icon1.png" alt=""> AC</li>
